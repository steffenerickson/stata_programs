...
{pstd}
Example of a multivariate person-by-task design: each person was assessed on five dimensions of a rubric across four repeated tasks (observations).
{p_end}
...
{pstd}
Example of a univariate person-by-task design: each person was assessed using a single average score across four repeated tasks (observations).
{p_end}
